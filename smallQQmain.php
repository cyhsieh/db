...
$result = mysqli_query($conn, "SELECT 記事編號,日期時間, 項目, 金額, 備註 FROM ".$mytable);

echo "
<div id = 'mainContent'><div id = 'contentTitle' ><span class = 'heart'>♥♥</span> 大小親親來記帳 - 小親親專用 <span class = 'heart'>♥♥</span></div>
